!(function (e, t) {
    ...
    return (function () {
      ...
      function E(e, t, n, r, i) {
        ...
        e: if ("style" === t)
          ...
          (s = t !== (t = t.replace(/Capture$/, ""))),
            ...
            (e.l[t + s] = n),
            n
              ? r || e.addEventListener(t, s ? S : A, s)
              : e.removeEventListener(t, s ? S : A, s);
      ...
      function N(e, t, n, i, s, o, a, l, c) {
        ...
        null != n.__h &&
          ((c = n.__h), (l = t.__e = n.__e), (t.__h = null), (o = [l])),
          (d = r.__b) && d(t);
        try {
            ...
            if (
              ...
              if (
                ...
                (!u.__e &&
                  ...
                  !1 === u.shouldComponentUpdate(b, u.__s, A)) ||
                  t.__v === n.__v)
              ) {
                for (
                  t.__v !== n.__v &&
      ...
      (r.__b = function (e) {
        ...
        (r.diffed = function (e) {
          ...
          t &&
            t.__H &&
            (t.__H.__h.length &&
              ((1 !== V.push(t) && F === r.requestAnimationFrame) ||
                ((F = r.requestAnimationFrame) || K)($)),
        ...
        (t.componentWillUnmount = function () {
          ...
          e.__v
            ? (t.l ||
              ...
              U(m(fe, { context: t.context }, e.__v), t.l))
              ...
              ("defaultValue" === s && "value" in n && null == n.value
                ...
                : "download" === s && !0 === o
                  ...
                  : /ondoubleclick/i.test(s)
                    ? (s = "ondblclick")
                    : /^onchange(textarea|input)/i.test(s + t) && !ye(n.type)
                      ? (s = "oninput")
                      : /^onfocus$/i.test(s)
                        ? (s = "onfocusin")
                        : /^onblur$/i.test(s)
      ...
      class Ut {
        constructor(e) {
          ...
          for (let i in e)
            i in Ot
              ? ((n[i] = e[i]), (r = Math.max(Ot[i], r)))
              : ((t[i] = e[i]), i in Nt && (r = Math.max(Nt[i], r)));
                    ...
                    (function (e, t, n, r, i) {
                      return (
                        ...
                        !1 === r.meridiem
                          ? (e = e.replace(Pt, "").trim())
                          : "narrow" === r.meridiem
                            ? (e = e.replace(Pt, (e, t) => t.toLocaleLowerCase()))
                            : "short" === r.meridiem
                              ? (e = e.replace(
                                  Pt,
                              ...
                              : "lowercase" === r.meridiem &&
                                (e = e.replace(Pt, (e) => e.toLocaleLowerCase())),
      ...
      function un(e, t) {
        if (e === t) return !0;
        for (let n in e) if (sn.call(e, n) && !(n in t)) return !1;
        for (let n in t) if (sn.call(t, n) && e[n] !== t[n]) return !1;
        return !0;
      }
      const hn = /^on[A-Z]/;
      function fn(e, t) {
      ...
      class yn {
        ...
        diffWholeMonths(e, t) {
          let { calendarSystem: n } = this;
          return _t(e) === _t(t) && n.getMarkerDay(e) === n.getMarkerDay(t)
            ? n.getMarkerMonth(t) -
                n.getMarkerMonth(e) +
        ...
        countDurationsBetween(e, t, n) {
          ...
          return n.years && ((r = this.diffWholeYears(e, t)), null !== r)
            ...
            : n.months && ((r = this.diffWholeMonths(e, t)), null !== r)
              ? r / (lt(n) / 30)
              : n.days && ((r = yt(e, t)), null !== r)
                ? r / lt(n)
                : (t.valueOf() - e.valueOf()) / ct(n);
        }
        startOf(e, t) {
          return "year" === t
            ? this.startOfYear(e)
        ...
        offsetForMarker(e) {
          return "local" === this.timeZone
            ? -Dt(wt(e)).getTimezoneOffset()
            : "UTC" === this.timeZone
              ? 0
              : this.namedTimeZoneImpl
                ? this.namedTimeZoneImpl.offsetForArray(wt(e))
                : null;
        }
        toDate(e, t) {
          return "local" === this.timeZone
            ...
            : "UTC" === this.timeZone
              ...
              : this.namedTimeZoneImpl
                ? new Date(
                    e.valueOf() -
                      1e3 * this.namedTimeZoneImpl.offsetForArray(wt(e)) * 60,
                  )
      ...
      function En(e) {
        ...
        for (
          r.debounceRendering = function (e) {
            ...
            U(m(An, {}), document.createElement("div"));
          n.length;
      ...
      class Rn extends D {
        shouldComponentUpdate(e, t) {
          return (
            this.debug && console.log(fn(e, this.props), fn(t, this.state)),
            !gn(this.props, e, this.propEquality) ||
              !gn(this.state, t, this.stateEquality)
          );
        }
        safeSetState(e) {
          gn(
      ...
      Tn.addPropsEquality({
        ...
        elAttrs: function (e, t) {
          const n = fn(e, t);
          for (let e of n) if (!hn.test(e)) return !1;
          return !0;
        },
        renderProps: un,
      });
      ...
      function Gn(e, t = st(0)) {
        ...
        return (
          e.start && ((n = bt(e.start)), r && r <= n && (r = pt(n, 1))),
          { start: n, end: r }
        );
      }
      function Qn(e, t, n, r) {
        return "year" === r
          ? st(n.diffWholeYears(e, t), "year")
          : "month" === r
            ? st(n.diffWholeMonths(e, t), "month")
            : (function (e, t) {
                let n = bt(e),
                  r = bt(t);
                return {
      ...
      class qn {
        ...
        adjustActiveRange(e) {
          ...
          return (
            n &&
              (lt(r) < 0 && ((s = bt(s)), (s = t.add(s, r))),
              lt(i) > 1 && ((o = bt(o)), (o = pt(o, -1)), (o = t.add(o, i)))),
            { start: s, end: o }
          );
        }
        buildRangeFromDuration(e, t, n, r) {
          ...
          return (
            lt(n) <= 1 &&
              this.isHiddenDay(i) &&
              ((i = this.skipHiddenDays(i, t)), (i = bt(i))),
            c(),
        ...
        buildDateIncrement(e) {
          ...
          return (
            n ||
            ((t = this.props.dateAlignment) ? st(1, t) : e || st({ days: 1 }))
          );
        }
        refineRange(e) {
          if (e) {
      ...
      function Xn(e, t, n) {
        ...
        for (let e in o) {
          ...
          if (n.recurringDef) {
            ...
            for (let t of l) {
              let n = Zn(e, { start: t, end: r.add(t, o) });
              a[n.instanceId] = n;
            }
          }
        }
      ...
      const Jn = {
        ...
        Kn = { start: rn, end: rn, date: rn, allDay: Boolean },
      ...
      function tr(e, t, n, r, i = rr(n), s, o) {
        ...
        let u = (function (e, t, n, r) {
          ...
          return (
            ...
            o && a && (a = bt(a)),
            s && ((c = s.marker), o && (c = bt(c)), a && c <= a && (c = null)),
            c
              ? (l = !0)
              : r ||
      ...
      function rr(e) {
        return Object.assign(
          Object.assign(Object.assign({}, ur), er),
      ...
      function or(e, t = { defs: {}, instances: {} }) {
        return (
      ...
      function yr(e) {
        return Object.assign(
          Object.assign(Object.assign({}, ur), mr),
      ...
      function Cr(e, t, n) {
        n.emitter.trigger(
          "select",
          Object.assign(Object.assign({}, Rr(e, n)), {
      ...
      function _r(e, t, n) {
        ...
        return (
          e
            ? ((s = bt(s)), (s = r.add(s, i.defaultAllDayEventDuration)))
      ...
      function kr(e, t, n, r, i) {
        ...
        return (
          ...
          t.allDay &&
            (l.range = { start: bt(l.range.start), end: bt(l.range.end) }),
          l.range.end < l.range.start &&
            (l.range.end = _r(t.allDay, l.range.start, i)),
          l
        );
      }
      class Mr {
      ...
      const Xr = { start: rn, end: rn, allDay: Boolean };
      function $r(e, t, n) {
      ...
      class oi {
        ...
        addEvent(e, t) {
          if (e instanceof Ir) {
            ...
            return (
              this.getCurrentData().eventStore.defs[t.defId] ||
                (this.dispatch({
                  type: "ADD_EVENTS",
                  eventStore: or({ def: t, instance: n }),
                }),
          ...
          if (i) {
            ...
            return (
              this.dispatch({ type: "ADD_EVENTS", eventStore: or(i) }),
              this.triggerEventAdd(e),
              e
            );
          }
        ...
        triggerEventAdd(e) {
          ...
          t.trigger("eventAdd", {
            ...
            relatedEvents: [],
            revert: () => {
              this.dispatch({ type: "REMOVE_EVENTS", eventStore: Or(e) });
            },
          });
        }
        getEventById(e) {
        ...
        getEventSourceById(e) {
          let t = this.getCurrentData(),
            n = t.eventSources;
          e = String(e);
          for (let r in n) if (n[r].publicId === e) return new Mr(t, n[r]);
          return null;
        }
        addEventSource(e) {
          let t = this.getCurrentData();
      ...
      class di {
        ...
        splitProps(e) {
          let t = this.getKeyInfo(e),
            ...
            l = {};
          this.eventUiBuilders = ln(
            t,
            (e, t) => this.eventUiBuilders[t] || Mt(ui),
          );
          for (let n in t) {
            let c = t[n],
              d = s[n] || ci,
      ...
      const gi = Qt({ year: "numeric", month: "long", day: "numeric" }),
        pi = Qt({ week: "long" });
      function mi(e, t, n = "day", r = !0) {
        ...
        if (s.navLinks) {
          ...
          return Object.assign(
            { title: Ke(s.navLinkHint, [a, e], a), "data-navlink": "" },
            r ? Ge(l) : { onClick: l },
          );
        }
        return { "aria-label": a };
      ...
      class Di {
        ...
        similarTo(e) {
          return (
            wi(this.tops || [], e.tops || []) &&
            wi(this.bottoms || [], e.bottoms || []) &&
            wi(this.lefts || [], e.lefts || []) &&
            wi(this.rights || [], e.rights || [])
          );
        }
      }
      function wi(e, t) {
      ...
      class xi extends _n {
        ...
        isValidSegDownEl(e) {
          return (
            ...
            !Ne(e, ".fc-event-mirror")
          );
        }
        isValidDateDownEl(e) {
          return !(
            Ne(e, ".fc-event:not(.fc-bg-event)") ||
            Ne(e, ".fc-more-link") ||
            Ne(e, "a[data-navlink]") ||
            Ne(e, ".fc-popover")
          );
      ...
      class Ti {
        ...
        insertEntryAt(e, t) {
          ...
          -1 === t.lateral
            ? (Oi(r, t.level, t.levelCoord), Oi(n, t.level, [e]))
            : Oi(n[t.level], t.lateral, e),
        ...
        findInsertion(e) {
          ...
          let h = -1;
          return (
            u < s && t[u] === o && (h = Ni(n[u], e.span.end, ki)[0]),
            {
              touchingLevel: a,
              touchingLateral: l,
              touchingEntry: c,
            ...
            (n) =>
              m(
                ...
                m(n, {
                  ...
                  elAttrs: { "aria-label": t.format(s, Ui) },
                }),
              ),
          );
        }
      ...
      class Wi extends D {
        ...
        computeTiming() {
          ...
          return (
            (s = Math.min(864e5, s)),
            {
              currentState: { nowDate: r, todayRange: Fi(r) },
              nextState: { nowDate: i, todayRange: Fi(i) },
              waitMs: s,
            }
          );
        }
      ...
      class qi {
        ...
        sliceNowDate(e, t, n, r, ...i) {
          return this._sliceDateSpan(
            { range: { start: e, end: mt(e, 1) }, allDay: !1 },
            t,
            n,
            {},
            r,
        ...
        _sliceBusinessHours(e, t, n, r, ...i) {
          return e
            ? this._sliceEventStore(Xn(e, Zi(t, Boolean(n)), r), {}, t, n, ...i)
                .bg
            : [];
        }
      ...
      function Xi(e, t, n) {
        ...
        for (let e in r) if (!Wn(t.validRange, r[e].range)) return !1;
        return $i({ eventDrag: e }, n);
      }
      function $i(e, t) {
          ...
          (e.eventDrag &&
            !(function (e, t, n, r) {
              let i = t.getCurrentData(),
                ...
                a = o.defs,
                l = o.instances,
                c = jr(a, s.isEvent ? e.eventUiBases : { "": i.selectionConfig });
              r && (c = ln(c, r));
              let d =
                  ((g = e.eventStore),
              ...
              for (let r in l) {
                ...
                for (let e of p.allows) {
                  let i,
                    ...
                    a = b.defs[m.defId],
                    l = b.instances[r];
                  if (((i = a ? new Ir(t, a, l) : new Ir(t, m)), !e(Rr(s, t), i)))
                    return !1;
                }
              }
              return !0;
      ...
      function Ki(e, t, n, r, i) {
        for (let s of e) if (!ns(es(s, t, n, r, i), t)) return !1;
        return !0;
      }
      ...
      function ns(e, t) {
        for (let n of e) if (Wn(n, t)) return !0;
        return !1;
      }
      ...
      class is extends _n {
        ...
        getXScrollbarWidth() {
          return rs.test(this.props.overflowX)
            ? 0
            : this.el.offsetHeight - this.el.clientHeight;
        }
        getYScrollbarWidth() {
          return rs.test(this.props.overflowY)
            ? 0
        ...
        return m(
          ...
          m(
            ...
            m(
              ...
              e.event.title || m(y, null, "Â "),
            ),
          ),
        );
      }
      const ys = (e) =>
          m(wn.Consumer, null, (t) => {
            let { options: n } = t,
              r = {
                isAxis: e.isAxis,
          ...
          return m(
            ...
            Object.assign({}, e, {
              ...
              elAttrs: Object.assign(
                ...
                r.isDisabled ? {} : { "data-date": Tt(e.date) },
              ),
              renderProps: r,
          ...
          return m(
            ...
            (t, r, i) =>
              m(
                ...
                As(e) &&
                  m(t, { elTag: "div", elClasses: ["fc-more-popover-misc"] }),
                n.children,
              ),
          );
        }
      ...
      function Qs(e) {
        ...
        return (
          t.content
            ? (n = Ys(t))
            : !n ||
              n.prototype instanceof _n ||
              (n = Ys(Object.assign(Object.assign({}, t), { content: n }))),
          { superType: t.type, component: n, rawOptions: t }
        );
      }
      function Ys(e) {
        return (t) =>
          m(wn.Consumer, null, (n) =>
            m(Nn, {
              elTag: "div",
          ...
          recurringTypes: [
            {
              ...
              expand(e, t, n) {
                let r = Un(t, { start: e.startRecur, end: e.endRecur });
                return r
                  ? (function (e, t, n, r) {
                      let i = e ? cn(e) : null,
                        s = bt(n.start),
        ...
        Ws({
          ...
          propSetHandlers: {
            dateProfile: function (e, t) {
              t.emitter.trigger(
                "datesSet",
                Object.assign(Object.assign({}, $r(e.activeRange, t.dateEnv)), {
                  view: t.viewApi,
                }),
              );
            },
      ...
      class vo {
                              ...
                              premiumReleaseDate:
                                ...
                                void 0 === t
                                  ...
                                  : void 0 === s
                                    ? t
                                    : new Date(
                                        Math.max(t.valueOf(), s.valueOf()),
                                      )),
                              reducers: o.reducers.concat(a.reducers),
                              isLoadingFuncs: o.isLoadingFuncs.concat(
                                a.isLoadingFuncs,
                              ),
                              contextInit: o.contextInit.concat(a.contextInit),
                              eventRefiners: Object.assign(
                                Object.assign({}, o.eventRefiners),
                                a.eventRefiners,
                              ),
                              eventDefMemberAdders: o.eventDefMemberAdders.concat(
                                a.eventDefMemberAdders,
                              ),
                              eventSourceRefiners: Object.assign(
                                Object.assign({}, o.eventSourceRefiners),
                                a.eventSourceRefiners,
                              ),
                              isDraggableTransformers:
                                o.isDraggableTransformers.concat(
                                  a.isDraggableTransformers,
                                ),
                              eventDragMutationMassagers:
                                o.eventDragMutationMassagers.concat(
                                  a.eventDragMutationMassagers,
                                ),
                              eventDefMutationAppliers:
                                o.eventDefMutationAppliers.concat(
                                  a.eventDefMutationAppliers,
                                ),
                              dateSelectionTransformers:
                                o.dateSelectionTransformers.concat(
                                  a.dateSelectionTransformers,
                                ),
                              datePointTransforms: o.datePointTransforms.concat(
                                a.datePointTransforms,
                              ),
                              dateSpanTransforms: o.dateSpanTransforms.concat(
                                a.dateSpanTransforms,
                              ),
                              views: Object.assign(
                                Object.assign({}, o.views),
                                a.views,
                              ),
                              viewPropsTransformers:
                                o.viewPropsTransformers.concat(
                                  a.viewPropsTransformers,
                                ),
                              isPropsValid: a.isPropsValid || o.isPropsValid,
                              externalDefTransforms:
                                o.externalDefTransforms.concat(
                                  a.externalDefTransforms,
                                ),
                              viewContainerAppends: o.viewContainerAppends.concat(
                                a.viewContainerAppends,
                              ),
                              eventDropTransformers:
                                o.eventDropTransformers.concat(
                                  a.eventDropTransformers,
                                ),
                              calendarInteractions: o.calendarInteractions.concat(
                                a.calendarInteractions,
                              ),
                              componentInteractions:
                                o.componentInteractions.concat(
                                  a.componentInteractions,
                                ),
                              themeClasses: Object.assign(
                                Object.assign({}, o.themeClasses),
                                a.themeClasses,
                              ),
                              eventSourceDefs: o.eventSourceDefs.concat(
                                a.eventSourceDefs,
                              ),
                              cmdFormatter: a.cmdFormatter || o.cmdFormatter,
                              recurringTypes: o.recurringTypes.concat(
                                a.recurringTypes,
                              ),
                              namedTimeZonedImpl:
                                a.namedTimeZonedImpl || o.namedTimeZonedImpl,
                              initialView: o.initialView || a.initialView,
                              elementDraggingImpl:
                                o.elementDraggingImpl || a.elementDraggingImpl,
                              optionChangeHandlers: Object.assign(
                                Object.assign({}, o.optionChangeHandlers),
                                a.optionChangeHandlers,
                              ),
                              scrollGridImpl:
                                a.scrollGridImpl || o.scrollGridImpl,
                              listenerRefiners: Object.assign(
                                Object.assign({}, o.listenerRefiners),
                                a.listenerRefiners,
                              ),
                              optionRefiners: Object.assign(
                                Object.assign({}, o.optionRefiners),
                                a.optionRefiners,
                              ),
                              propSetHandlers: Object.assign(
                                Object.assign({}, o.propSetHandlers),
                                a.propSetHandlers,
                              ),
                            }))
        ...
        _handleAction(e) {
          ...
          this.data &&
            ...
            ("PREV" !== e.type && "NEXT" !== e.type && Fn(d.currentRange, c)) ||
          ...
          let u = (function (e, t, n, r) {
              ...
              switch (t.type) {
                ...
                case "REMOVE_EVENT_SOURCE":
                  return (
                    (s = e), (o = t.sourceId), an(s, (e) => e.sourceId !== o)
                  );
                case "PREV":
                case "NEXT":
                case "CHANGE_DATE":
                ...
                case "FETCH_EVENT_SOURCES":
                  return Ks(
                    e,
                    t.sourceIds ? cn(t.sourceIds) : to(e, r),
                    i,
                    t.isRefetch || !1,
                    r,
                  );
          ...
          if (a && a !== l) {
            a.timeZone !== l.timeZone &&
              ...
              (t.eventStore = s.eventStore =
                Ar(s.eventStore, n.dateEnv, s.dateEnv)),
              (t.renderableEventStore = s.renderableEventStore =
                Ar(s.renderableEventStore, n.dateEnv, s.dateEnv)));
            for (let e in o)
        ...
        processRawCalendarOptions(e, t) {
          let { locales: n, locale: r } = tn([qt, e, t]),
            ...
            l = (this.currentCalendarOptionsRefiners = Object.assign(
              Object.assign(
                Object.assign(Object.assign(Object.assign({}, Yt), Zt), Xt),
                a.listenerRefiners,
              ),
              a.optionRefiners,
            )),
          ...
          for (let e in d)
            ...
            (d[e] === h[e] || ($t[e] && e in h && $t[e](h[e], d[e])))
              ? (u[e] = f[e])
              : l[e]
                ? ((u[e] = l[e](d[e])), (g = !0))
                : (c[e] = h[e]);
        ...
        processRawViewOptions(e, t, n, r, i) {
          let s = tn([qt, e.optionDefaults, n, r, e.optionOverrides, i]),
            ...
            u = {};
          for (let e in s)
            s[e] === l[e] || ($t[e] && $t[e](s[e], l[e]))
              ? (a[e] = c[e])
              : (s[e] === this.currentCalendarOptionsInput[e] ||
                ($t[e] && $t[e](s[e], this.currentCalendarOptionsInput[e]))
          ...
          return m(
            ...
            (s, a) =>
              m(
                ...
                !a.isDisabled && (t.showDayNumber || As(i) || t.forceDayTop)
                  ? m(
                      "div",
                  ...
                  : t.showDayNumber
                    ? m(
                        ...
                        m("a", { className: "fc-daygrid-day-number" }, "Â "),
                      )
                    : void 0,
                m(
                  "div",
      ...
      function Xo(e) {
        return e.dayNumberText || m(y, null, "Â ");
      }
      function $o(e) {
      ...
      function Ko(e, t, n, r) {
        ...
        let i = e.eventRange,
          s = i.range,
          o = Un(s, { start: r[t].date, end: pt(r[n - 1].date, 1) });
                  ...
                  m(
                    "div",
                    {
                      className:
                        ...
                        (p ? " fc-daygrid-event-harness-abs" : ""),
                      key: $o(t),
            ...
            for (let o of e) {
              ...
              s.push(
                m(
                  ...
                  "bg-event" === t
                    ? m(Ds, Object.assign({ seg: o }, Qr(o, r)))
                    : Cs(t),
                ),
              );
            }
            ...
            if (e) {
              ...
              if (e.length) {
                ...
                (n.framePositions && n.framePositions.similarTo(r)) ||
                  this.setState({ framePositions: new Di(t, e, !0, !1) });
              }
            }
      ...
      ta.addStateEquality({ segHeights: un });
      class na extends xi {
        constructor() {
          super(...arguments),
        ...
        prepareHits() {
          (this.rowPositions = new Di(
            this.rootEl,
            this.rowRefs.collect().map((e) => e.getCellEls()[0]),
            !1,
            !0,
          )),
            (this.colPositions = new Di(
              this.rootEl,
      ...
      class ha {
        constructor(e) {
          (this.subjectEl = null),
            ...
            (da += 1),
            1 === da && window.addEventListener("touchmove", fa, { passive: !1 });
        }
        destroy() {
          this.containerEl.removeEventListener("mousedown", this.handleMouseDown),
            ...
            (da -= 1),
            da || window.removeEventListener("touchmove", fa, { passive: !1 });
        }
        tryStart(e) {
          ...
          return !(
            !t ||
            (this.handleSelector && !Ne(n, this.handleSelector)) ||
            ((this.subjectEl = t),
            (this.isDragging = !0),
            (this.wasTouchScroll = !1),
            0)
      ...
      class ga {
        ...
        cleanup() {
          this.mirrorEl && (Oe(this.mirrorEl), (this.mirrorEl = null)),
            (this.sourceEl = null);
        }
        updateElPosition() {
          this.sourceEl &&
        ...
        handleMove(e, t) {
          if (this.isEnabled) {
            ...
            i < 0 ? (this.everMovedUp = !0) : i > 0 && (this.everMovedDown = !0),
              ...
              this.isAnimating ||
                ((this.isAnimating = !0), this.requestAnimation(ya()));
          }
        }
        stop() {
          if (this.isEnabled) {
      ...
      class Da {
        ...
        handleMove(e, t) {
          ...
          (!t && wa(this.movingHit, n)) ||
            ((this.movingHit = n), this.emitter.trigger("hitupdate", n, !1, e));
        }
        prepareHits() {
          this.offsetTrackers = ln(
            this.droppableStore,
            (e) => (e.component.prepareHits(), new Aa(e.el)),
          );
        }
        releaseHits() {
          ...
          for (let s in n) {
            ...
            if (a && a.isWithinClipping(e, t)) {
              ...
              if (l >= 0 && l < u && c >= 0 && c < h) {
                ...
                e &&
                  Wn(e.dateProfile.activeRange, e.dateSpan.range) &&
        ...
        return (
          ...
          (Boolean(e) === Boolean(t) &&
            ...
            (null === i.start ? null : i.start.valueOf()) ===
              (null === s.start ? null : s.start.valueOf()) &&
              (null === i.end ? null : i.end.valueOf()) ===
                (null === s.end ? null : s.end.valueOf()) &&
              n.allDay === r.allDay &&
              (function (e, t) {
                for (let n in t)
                ...
                if (
                  ...
                  if (r === t) {
                    ...
                    r.emitter.trigger("eventAdd", g),
                      ...
                      r.emitter.trigger(
                        "drop",
                        Object.assign(Object.assign({}, Ca(d.dateSpan, r)), {
                          draggedEl: e.subjectEl,
                          jsEvent: e.origEvent,
          ...
          class extends ri {
            constructor(e) {
              super(e),
                ...
                (this.handlePointerUp = (e) => {
                  this.dragSelection &&
                    (Cr(this.dragSelection, e, this.component.context),
                    (this.dragSelection = null));
                });
              let { component: t } = e,
                { options: n } = t.context,
      ...
      const Ia = Qt({ hour: "numeric", minute: "2-digit", meridiem: "short" });
      class Oa extends _n {
        render() {
          let { props: e, context: t } = this,
            { options: n } = t,
                    ...
                    if (
                      (a.allDay
                        ...
                        : (function (e) {
                          ...
                          ? e.isStart
                            ? (o = Gr(e, t, n, null, null, l.range.start, e.end))
                            : e.isEnd
                              ? (o = Gr(
                                  e,
                                  t,
            ...
            component: class extends xi {
              ...
              renderEmptyMessage() {
                ...
                return m(
                  ...
                  (e) =>
                    m(e, { elTag: "div", elClasses: ["fc-list-empty-cushion"] }),
                );
              }
              renderSegList(e, t) {
      ...
      function La(e) {
        ...
        return m(wn.Consumer, null, (n) => {
          if (!e.isLabeled)
            return m("td", { className: t.join(" "), "data-time": e.isoTimeStr });
          let { dateEnv: r, options: i, viewApi: s } = n,
            o =
              null == i.slotLabelFormat
                ? Ua
                : Array.isArray(i.slotLabelFormat)
                  ? Qt(i.slotLabelFormat[0])
                  : Qt(i.slotLabelFormat),
            a = {
              level: 0,
              time: e.time,
      ...
      class Fa extends _n {
        render() {
          return this.props.slatMetas.map((e) =>
            m("tr", { key: e.key }, m(La, Object.assign({}, e))),
          );
        }
      }
      const Va = Qt({ week: "short" });
      class Ga extends xi {
        constructor() {
          super(...arguments),
                  ...
                  content: (e) =>
                    m(
                      ...
                      m(
                        ...
                        e.tableColGroupNode,
                        m("tbody", null, m(Fa, { slatMetas: s })),
                      ),
                      m(
                        "div",
                        { className: "fc-timegrid-now-indicator-container" },
                        m(Wi, { unit: f ? "minute" : "day" }, (e) => {
      ...
      class Ya {
        ...
        computeDateTop(e, t) {
          return (
            t || (t = bt(e)), this.computeTimeTop(st(e.valueOf() - t.valueOf()))
          );
        }
        computeTimeTop(e) {
          let t,
      ...
      const sl = Qt({ hour: "numeric", minute: "2-digit", meridiem: !1 });
      class ol extends _n {
        render() {
          return m(
            ms,
      ...
      class al extends _n {
          ...
          return m(
            ...
            (t) =>
              m(
                ...
                As(n) &&
                  m(t, { elTag: "div", elClasses: ["fc-timegrid-col-misc"] }),
              ),
          );
        }
        ...
        renderFillSegs(e, t) {
          let { props: n, context: r } = this,
            i = il(e, n.date, n.slatCoords, r.options.eventMinHeight).map(
              (r, i) => {
                let s = e[i];
                return m(
                  "div",
                  ...
                  "bg-event" === t
                    ? m(
                        Ds,
                        Object.assign({ seg: s }, Qr(s, n.todayRange, n.nowDate)),
                      )
                    : Cs(t),
                );
              },
      ...
      class gl extends xi {
        ...
        render() {
          ...
          return m(Wi, { unit: i ? "minute" : "day" }, (a, l) =>
            m(
              ul,
              Object.assign(
          ...
          l =
            ...
            (function (e) {
              ...
              for (t = ml.length - 1; t >= 0; t -= 1)
                if (((n = st(ml[t])), (r = dt(n, e)), null !== r && r > 1))
                  return n;
              return e;
            })(r),
          c = [];
        for (; ct(o) < ct(t); ) {
          ...
          c.push({
            ...
            isoTimeStr:
              ...
              Je(d.getUTCHours(), 2) +
                ":" +
                Je(d.getUTCMinutes(), 2) +
                ":" +
                Je(d.getUTCSeconds(), 2)),
            isLabeled: t,
          }),
            (o = at(o, r)),
            (a = at(a, r));
